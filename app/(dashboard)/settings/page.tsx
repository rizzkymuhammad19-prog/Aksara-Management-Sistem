  ...
  return (
    <div className="max-w-lg space-y-6">
      <div>
        ...
        <p className="text-sm text-text-secondary">Jam kerja & hari kerja di sini otomatis dipakai modul Absensi.</p>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-xs text-text-secondary mb-4">Tanggal-tanggal ini tidak dihitung sebagai hari kerja (cuti bersama, libur nasional, dll).</p>
